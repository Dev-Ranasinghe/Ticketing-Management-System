...
//        // Create and start a thread to handle fetching vendor by email
//        VendorService.VendorThread fetchByEmailThread = vendorService.new VendorThread("fetchByEmail", null, email);
//        fetchByEmailThread.start();
