...
public class EventService {
    ...
    // Vendor adds tickets in a separate thread
//    public void addTickets(int vendorId, int ticketCount) {
//        new Thread(() -> {
//            lock.lock();
//            try {
//                event.setTotalTickets(event.getTotalTickets() + ticketCount);
//                System.out.println("Vendor added " + ticketCount + " tickets. Total tickets: " + event.getTotalTickets());
